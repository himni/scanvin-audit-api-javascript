...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Auditoria.InspectionSubmitRequest();
  });
  ...
  describe('InspectionSubmitRequest', function() {
    it('should create an instance of InspectionSubmitRequest', function() {
      // uncomment below and update the code to test InspectionSubmitRequest
      //var instane = new Auditoria.InspectionSubmitRequest();
      //expect(instance).to.be.a(Auditoria.InspectionSubmitRequest);
    });
    ...
    it('should have the property postbackUrl (base name: "postback_url")', function() {
      // uncomment below and update the code to test the property postbackUrl
      //var instane = new Auditoria.InspectionSubmitRequest();
      //expect(instance).to.be();
    });
