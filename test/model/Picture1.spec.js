...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Auditoria.Picture1();
  });
  ...
  describe('Picture1', function() {
    it('should create an instance of Picture1', function() {
      // uncomment below and update the code to test Picture1
      //var instane = new Auditoria.Picture1();
      //expect(instance).to.be.a(Auditoria.Picture1);
    });
    ...
    it('should have the property pathOriginal (base name: "path_original")', function() {
      // uncomment below and update the code to test the property pathOriginal
      //var instane = new Auditoria.Picture1();
      //expect(instance).to.be();
    });

    it('should have the property pathUpdated (base name: "path_updated")', function() {
      // uncomment below and update the code to test the property pathUpdated
      //var instane = new Auditoria.Picture1();
      //expect(instance).to.be();
    });
