...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Auditoria.InspectionGetInspection();
  });
  ...
  describe('InspectionGetInspection', function() {
    it('should create an instance of InspectionGetInspection', function() {
      // uncomment below and update the code to test InspectionGetInspection
      //var instane = new Auditoria.InspectionGetInspection();
      //expect(instance).to.be.a(Auditoria.InspectionGetInspection);
    });
