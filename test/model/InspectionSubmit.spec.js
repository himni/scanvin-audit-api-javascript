...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Auditoria.InspectionSubmit();
  });
  ...
  describe('InspectionSubmit', function() {
    it('should create an instance of InspectionSubmit', function() {
      // uncomment below and update the code to test InspectionSubmit
      //var instane = new Auditoria.InspectionSubmit();
      //expect(instance).to.be.a(Auditoria.InspectionSubmit);
    });
