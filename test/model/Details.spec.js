...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Auditoria.Details();
  });
  ...
  describe('Details', function() {
    it('should create an instance of Details', function() {
      ...
      //var instane = new Auditoria.Details();
      //expect(instance).to.be.a(Auditoria.Details);
    });

    it('should have the property auditor (base name: "auditor")', function() {
      // uncomment below and update the code to test the property auditor
      //var instane = new Auditoria.Details();
