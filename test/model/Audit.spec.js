...
(function(root, factory) {
  ...
  describe('Audit', function() {
    it('should create an instance of Audit', function() {
      ...
      //var instane = new Auditoria.Audit();
      //expect(instance).to.be.a(Auditoria.Audit);
    });
    ...
    it('should have the property impeachment (base name: "impeachment")', function() {
      // uncomment below and update the code to test the property impeachment
      //var instane = new Auditoria.Audit();
      //expect(instance).to.be();
    });
